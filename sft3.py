...
class TrainingConfig:
    ...
    def _resolve_model_alias(self, name: str) -> str:
        ...
        mapping = {
            ...
            # 本地模型路径
            "qwen3-8b": "/data1/czj/model/qwen3-8b",
            "qwen3-4b": "/data1/czj/model/Qwen3-4b",
            "codellama-13b": "/data1/czj/model/codeLlama-13b-instruct",
            "llama3-8b": "/data1/czj/model/Llama-3-8B-Instruct",
            "llama3.1-8b": "/data1/czj/model/Llama-3-8B-Instruct",
        }
